        ...
        <div class="content-header-right col-md-6 col-12">
            <div class="dropdown float-md-right">
                <a href="{{route('admin.roles.create')}}">
                    <input class="btn btn-danger btn-glow px-2" type="button" data-target="#info" aria-haspopup="true" value="Add">
                </a>
            </div>
        </div>
    </div>
                            ...
                            <table class="table table-striped dataex-html5-selectors">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="{{route('admin.roles.edit',$role->id)}}"><i class="ft-edit text-success" data-toggle="modal" data-target=""></i></a>
