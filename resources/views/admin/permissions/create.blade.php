<x-admin-layout>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="name" placeholder="Enter Permissions">
    @error('name') <span style="color: red; font-weight:400;">{{$message}}</span>@enderror
  </div>
  
  <button type="submit" class="btn btn-danger  round btn-glow px-2">Create</button>
</form>
                            </div>
                        </div>
                    </div>
